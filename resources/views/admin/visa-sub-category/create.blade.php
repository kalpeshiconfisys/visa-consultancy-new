        ...
        <div class="card shadow-sm border-0 rounded-4 my-4">
            <div class="card-body p-4">
                ...
                <form action="{{ route('admin.visa-sub-category.store') }}" method="POST">
                    ...
                    <button type="button" class="btn btn-primary justify-content-end  addSubCategory mt-2 mb-3">+ Add Table Of Content</button>

                    <div id="subCategoryWrapper">
                        <div class="subCategoryBox card p-3 mb-3 border rounded shadow-sm">
                               <div class="d-flex justify-content-between align-items-center mb-2">
                            <h4 class="fw-bold">Table Of Content</h4>
                           <button type="button" class="remove-subcategory-btn" title="Remove Table of Content" style="display:none;">✕</button>
</div>
                            <div class="mt-2">
                                <label class="fw-bold">Title</label>
                            ...
                            <div class="mt-2 bulletsArea">
                                ...
                                <button type="button" class="btn btn-sm btn-success addBullet fst-italic">+ Add Bullet</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 d-flex gap-2">
                        ...
                        <button type="submit" name="publish_is" value="2" class="btn btn-secondary px-4 fst-italic">Publish</button>
                    </div>
                </form>
            </div>
        </div>
