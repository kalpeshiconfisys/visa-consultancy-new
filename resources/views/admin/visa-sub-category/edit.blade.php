            ...
            <div class="card-body p-4">
                ...
                <form action="{{ route('admin.visa-sub-category.update', $subCategories->id) }}" method="POST">
                    ...
                    <div class="row mb-3">
                     ...
                     <div class="mt-2">
                                <label class="fw-bold">Title</label>
                                <input type="text" name="sub_title" class="form-control" placeholder="Enter Title" value="{{ $subCategories->title }}" required>
                            </div>
                            <div class="mt-2 descBox">
                                <label class="fw-bold">Description</label>
                    ...
                    <button type="button" class="btn btn-primary addSubCategory mb-3">+ Add Table Of Content</button>
