            ...
            <div class="card shadow-sm rounded-4 my-4 main-category-card">
                <div class="card-body p-4 ">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class=" m-0">Add Legal Assistance</h4>
                        <a href="{{ url('admin/legal-assistance') }}" class="btn custom-theme-color   text-color">
                        ...
                        <div class="row g-4 border rounded shadow-sm mt-3 pb-3">
                            <div class="col-lg-7 col-md-12 ">
                                ...
                                <div class="mt-3">
                                    ...
                                    <textarea class="form-control" name="description" rows="2" placeholder="Write short introduction..."
                                        required> </textarea>
                                </div>
