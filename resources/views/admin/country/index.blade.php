                ...
                <div class="card-body p-4">
                    ...
                    <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    {{-- VIEW --}}
                                                    <a href="{{ route('admin.country.show' , trim(base64_encode($i->id), '=')) }}"
                                                        class="btn btn-sm btn-outline-secondary custom-show  px-2  ">
                                                        <i class="fa-solid fa-eye me-1"></i>
                                                    </a>
                                                    {{-- EDIT --}}
                                                    <a href="{{ route('admin.country.edit' , trim(base64_encode($i->id), '=')) }}"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form
                                                                    action="{{ route('admin.country.destroy' , trim(base64_encode($i->id), '=')) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                        ...
                        <div class="d-flex justify-content-end mt-1">
                            {{ $country->onEachSide(1)->links('pagination::bootstrap-4') }}
                        </div>
