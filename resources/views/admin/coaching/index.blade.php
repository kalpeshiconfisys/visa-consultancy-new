                ...
                <div class="card-body custom-shadow  p-4">
                    <div class="card-header bg-white d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            <h4 class="card-title   m-0 ">Coaching List</h4>
                        </div>
                        <a href="{{ route('admin.coaching.create') }}"
                            ...
                            <i class="fas fa-plus"></i> Add Coaching
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example" class="table" style="min-width: 1000px;">
                                ...
                                <tbody>
                                        ...
                                        <tr class="table-row-muted">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    {{-- VIEW --}}
                                                    <a href="{{ route('admin.coaching.show' , trim(base64_encode($i->id), '=')) }}"
                                                        class="btn btn-sm     px-2  ">
                                                        <i class="fa-solid fa-eye me-1"></i>
                                                    </a>
                                                    {{-- EDIT --}}
                                                    <a href="{{ route('admin.coaching.edit' , trim(base64_encode($i->id), '=')) }}"
                                                        class="btn btn-sm    px-2">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form
                                                                    action="{{ route('admin.coaching.destroy' , trim(base64_encode($i->id), '=')) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="6" class="text-center text-muted">No Country found.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
                        ...
                        <div class="d-flex justify-content-end mt-1">
                            {{ $coaching->onEachSide(1)->links('pagination::bootstrap-4') }}
                        </div>
